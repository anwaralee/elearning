<?php
class Site_conf_model extends CI_Model
{
	function login_setting()
	{
		$q = mysql_query("SELECT * FROM tbl_admin LIMIT 1");
	...
	function edit_login()
	{
		...
		$q="update tbl_admin set admin_username='$un', admin_password='$new_pw', admin_email1='$first', admin_email2='$second', status=1";
		$res=mysql_query($q);
		if($res)
		{
			return $res;	
