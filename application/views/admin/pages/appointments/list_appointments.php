<script type="text/javascript">
    ...
    {
        return confirm("Are you sure you want to remove the Appointment?");	
    }
</script>
<div class="h_left"><h2>Appointment Management </h2></div>
<div class="seperator"></div>
<div class="add_new"><a href="<?php echo base_url();?>timeslot/list_appointment_timeslots" class="btn btn-inverse">Manage Time Slots</a></div>
<div class="seperator"></div>
    ...
    <table width="70%">
        ...
        foreach ($allAppointments as $appointment):
            ...
            <tr>
                ...
                <td class='action'>
                    <a href="<?php echo base_url(); ?>appointment/remove/<?php echo $appointment->appointment_id; ?>" onclick='return show_confirm()' class='btn btn-danger'>Remove</a> 
