...
?>
<form action="<?php echo base_url();?>document_manager/update_document/<?php echo $document->doc_id;?>" method="post" enctype="multipart/form-data" id="lesson">
...
<select name="lesson_id">
    ...
    <option value="<?php echo $schedule->lesson_id;?>" <?php echo $selected;?>><?php echo $this->document_model->getLessonNameById($schedule->lesson_id)->lesson_name;?></option>
    <?php endforeach; ?>
</select>
